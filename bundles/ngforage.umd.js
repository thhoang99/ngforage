(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('localforage'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ngforage', ['exports', 'localforage', '@angular/core'], factory) :
    (factory((global.ngforage = {}),global.localforage,global.ng.core));
}(this, (function (exports,lf,i0) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var DEFAULT_CONFIG = new i0.InjectionToken('Default NgForage config');
    ...
    var NgForageConfig = /** @class */ (function () {
        ...
        NgForageConfig.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [DEFAULT_CONFIG,] }] }
            ];
        };
        /** @nocollapse */ NgForageConfig.ngInjectableDef = i0.defineInjectable({ factory: function NgForageConfig_Factory() { return new NgForageConfig(i0.inject(DEFAULT_CONFIG, 8)); }, token: NgForageConfig, providedIn: "root" });
    ...
    var InstanceFactory = /** @class */ (function () {
        ...
        /** @nocollapse */ InstanceFactory.ngInjectableDef = i0.defineInjectable({ factory: function InstanceFactory_Factory() { return new InstanceFactory(i0.inject(NgForageConfig)); }, token: InstanceFactory, providedIn: "root" });
    ...
    var BaseConfigurableImpl = /** @class */ (function () {
        ...
        BaseConfigurableImpl.ctorParameters = function () {
            return [
                { type: NgForageConfig, decorators: [{ type: i0.Inject, args: [NgForageConfig,] }] },
                { type: InstanceFactory, decorators: [{ type: i0.Inject, args: [InstanceFactory,] }] }
            ];
        };
    ...
    var NgForage = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ NgForage.ngInjectableDef = i0.defineInjectable({ factory: function NgForage_Factory() { return new NgForage(i0.inject(NgForageConfig), i0.inject(InstanceFactory)); }, token: NgForage, providedIn: "root" });
        return NgForage;
    ...
    var NgForageCache = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ NgForageCache.ngInjectableDef = i0.defineInjectable({ factory: function NgForageCache_Factory() { return new NgForageCache(i0.inject(NgForageConfig), i0.inject(InstanceFactory)); }, token: NgForageCache, providedIn: "root" });
    ...
    var DedicatedInstanceFactory = /** @class */ (function () {
        ...
        /** @nocollapse */ DedicatedInstanceFactory.ngInjectableDef = i0.defineInjectable({ factory: function DedicatedInstanceFactory_Factory() { return new DedicatedInstanceFactory(i0.inject(NgForageConfig), i0.inject(InstanceFactory)); }, token: DedicatedInstanceFactory, providedIn: "root" });
